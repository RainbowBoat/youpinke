...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="showLoginName();num=1;loadSku()">
							...
							<div class="items">
								<ul>
									<#list imageList as item>
									    <li>
											<img src="${item.url}" bimg="${item.url}"
								...
								<#list spec.attributeValue as value>
								    <dd>
										<a href="javascript:;"
											...
											ng-click="select('${spec.attributeName}', '${value}')">${value}</a>
									</dd>
								</#list>
							</dl>
							</#list>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input type="text" value="{{num}}" ng-model="num" class="itxt" />
										<a href="javascript:void(0)" class="increment plus" ng-click="updateNum(1)">+</a>
										<a href="javascript:void(0)" class="increment mins" ng-click="updateNum(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
